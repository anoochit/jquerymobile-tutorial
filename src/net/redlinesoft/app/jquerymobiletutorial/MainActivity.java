package net.redlinesoft.app.jquerymobiletutorial;
...
import net.redlinesoft.app.jquerymobiletutorial.R;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (checkNetworkStatus()) {
			...
			// Create the adView
			adView = new AdView(this, AdSize.SMART_BANNER, "a151169b852c9fe");
